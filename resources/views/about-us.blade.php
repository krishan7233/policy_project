         ...
         <div class="hero-text-inner">
            <div class="row">
               <div class="col-lg-6 col-md-6 col-sm-12 m-auto text-center">
                  <h3><span class="sub-heading-1">About Us</span></h3>
...
<section class="make-us-section inner-page">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="title-center">
...
<div class="section-larger about-founder">
  <div class="container">
    <!--<div class="row">
      <div class="col-lg-12">
        <div class="title-center">
	...
	<div class="founder-corner">
		<div class="row">
			...
			<div class="col-lg-5">
				<img src="assets/images/founder.png" class="img-fluid" alt="">
			</div>
		</div>
	</div>
...
<span id="text">
<p>With a profound understanding of the importance of financial security and a genuine desire to make a difference, Sanjeev Malik has become a driving force in the insurance industry. His dedication to providing Canadians with access to the best insurance options and expert advice has earned him the trust and respect of countless individuals seeking to safeguard their financial well-being.</p><br />
...
<button type="button" class="btn btn-prim-round" id="toggle">Read more</button>
