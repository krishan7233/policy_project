    ...
    print_r($array_check);
        ...
        @endphp -->
            ...
            if($compare->plan_type==1){
              $photo = $compare->basic;
              $compare_data = json_decode($compare->compare_basic,true);

            }
            if($compare->plan_type==2){
              $photo = $compare->standard;
              $compare_data = json_decode($compare->compare_standard,true);
            ...
            <div class="col-sm-3">
              <div class="row">
                ...
                <div class="col-sm-12 border_div6"  style="padding:9px;margin-top:1px">
                  <a href="{{url('single-plan',$compare->id)}}" target="_blank" class="buy-now">BUY NOW</a>
                </div>
