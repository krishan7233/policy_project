      ...
      <div class="navbar-light bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
			...
			<li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown_1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Investments </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown" id="navbarDropdown"> 
				  <a class="dropdown-item" href="#">RESP</a> 
				  <a class="dropdown-item" href="#">RRSP</a> 
				  <a class="dropdown-item" href="#">TFSA</a> 
			  </div>
            </li>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item"> <a class="nav-link" href="#">About Us</a> </li>
           ...
           <li class="nav-item"> <a class="nav-link" href="{{ route('visitor-visa-insurance') }}">Visitor Visa Insurance</a> </li>
          <li class="nav-item"> <a class="nav-link" href="#">Contact</a> </li>
        </ul>
