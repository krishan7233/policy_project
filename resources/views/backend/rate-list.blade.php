                ...
                <div class="row">
                  ...
                  <div class="col">
                    <select name="type" id="" class="form-control">
                      ...
                      <option value="1" <?php if(request('type')==1){echo"selected";}?>>Basic</option>
                      <option value="2" <?php if(request('type')==2){echo"selected";}?>>Standard</option>
                      <option value="3" <?php if(request('type')==3){echo"selected";}?>>Enhanched</option>
                    </select>
                  </div>
                  <div class="col">
                    <select name="exit" id="" class="form-control">
                      <option value="" selected >-- select medical --</option>
                      <option value="1" <?php if(request('exit')==1){echo"selected";}?>>Yes</option>
                      <option value="2" <?php if(request('exit')==2){echo"selected";}?>>No</option>
                    </select>
                  </div>
                  <div class="col">
