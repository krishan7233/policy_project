...
if($company[0]->plan_type1==1){
    $photo = $company[0]->basic1;
    $compare_data = json_decode($company[0]->compare_basic1,true);

}
if($company[0]->plan_type1==2){
    $photo = $company[0]->standard1;
    $compare_data = json_decode($company[0]->compare_standard1,true);

}
if($company[0]->plan_type1==3){
    $photo = $company[0]->enhanced1;
    $compare_data = json_decode($company[0]->compare_enhanced1,true);

}
$tamt1 = $company[0]->total_charge1 - $company[0]->detect_amt1;
$tamt2 = $company[0]->total_charge2 - $company[0]->detect_amt2;
$sum_total_amt = number_format(($company[0]->total_charge1 - $company[0]->detect_amt1)+($company[0]->total_charge2 - $company[0]->detect_amt2),2);
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
              ...
              <h3><span>$</span>{{number_format($tamt1,2)}}<span></span></h3>
              <h3><span>$</span>{{number_format($tamt2,2)}}<span></span></h3>
            ...
            <div class="col-lg-6">
                ...
                @endif
                	<form action="{{route('couple-plan-post')}}" method="POST">
                        @csrf
