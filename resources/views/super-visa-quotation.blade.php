    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="quote-left">
          ...
          @endphp
          <p>Super Visa Insurance for Couple(age {{$age1}} years and {{$age2}} years) for {{$no_of_days1}} days, {{$exits_data}}. <a href="{{url('super-visa')}}"><span><i class="fa fa-pencil"></i></span></a></p>
          ...
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="not_exit1" name="super_couple_exit1" class="custom-control-input " value="0" {{$deductible['pre_exit1']==0 ? 'checked' : ''}}>
      ...
      @foreach($company_detail as $companies)
        ...
        $plan_type1=$no_of_days1=$total_charge1=$per_month1=$total_charge1=$deductible_amt1=$sur_charge1=$detect_amt1=$photo=$per_month_exit=$companies_id1=0;
        }
      ...
      <div class="quote-right">
          <div class="quote-box">
            ...
            <div class="price-section">
              ...
              ?>
              <h3><span>Deductible <strong>{{$deductible_amt1}}</strong><?php if($companies_id1==4 || 11 || 10 || 7){ echo" per policy";}else{ echo" per claim";}  ?></span></h3>
            </div>
            ...
            <a href="#" class="plan-details toggle togglePlanDetails" id="toggle" onclick="togglePlanDetails_{{$id1}}({{$id1}})">PLAN DETAILS</a>
              <div class="compaire">
                <div class="left">
                  <input type="checkbox" class="form-check-input super_visa_couple_compare" id="super_visa_couple_compare" value="{{$companies->id1}}">
                  <label class="form-check-label" for="super_visa_couple_compare">Compare</label>
                  <button class="btn btn-primary super_visa_couple_compare_data" id="super_visa_couple_compare_btn_{{$companies->id1}}" style="display:none;">COMPARE</button>
